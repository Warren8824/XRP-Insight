...
def setup_logger(
    name, log_directory, file_level=logging.INFO, console_level=logging.WARNING
):
...
def configure_loggers():
    ...
    return {
        "ai_integration": setup_logger(
            "ai_integration", log_directory, file_level, console_level
        ),
        ...
        "content_generation": setup_logger(
            "content_generation", log_directory, file_level, console_level
        ),
        "data_collection": setup_logger(
            "data_collection", log_directory, file_level, console_level
        ),
        "data_processing": setup_logger(
            "data_processing", log_directory, file_level, console_level
        ),
        "models": setup_logger("models", log_directory, file_level, console_level),
        "scheduler": setup_logger(
            "scheduler", log_directory, file_level, console_level
        ),
