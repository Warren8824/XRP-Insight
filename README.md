...
We welcome contributions from developers of all skill levels! This is my first big project, and I'm excited to collaborate with others who are passionate about cryptocurrency analysis and AI. Check out the [ROADMAP](docs/ROADMAP.md), to see the long list of tasks we intend on tackling in the coming phases.
