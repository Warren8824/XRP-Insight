...
from src.data_collection.collector import collect_and_store_market_data, collect_and_store_ohlcv_data, collect_historical_data, run_data_collection
...
class TestCollector(unittest.TestCase):
    ...
    def test_collect_historical_data(self, mock_coinapi):
        ...
        mock_coinapi_instance.get_historical_ohlcv_data.return_value = mock_data[:95]  # Return only 95 data points
